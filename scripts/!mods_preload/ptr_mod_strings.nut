...
gt.Const.PTR.modStrings <- function()
{
	...
	gt.Const.Strings.PerkDescription.PTRFluidWeapon <- "[color=" + this.Const.UI.Color.NegativeValue + "]Requires: Sword[/color]\nConfidence in your defenses allows you to focus on utilizing the speed and efficiency of your blade!\n\n[color=" + this.Const.UI.Color.Passive + "][u]Passive:[/u][/color]\n• Gain [color=" + this.Const.UI.Color.PositiveValue + "]25%[/color] of your Base Melee Defense as Initiative and percentage Fatigue Cost Reduction for weapon skills when wearing armor with a total penalty to Maximum Fatigue of [color=" + this.Const.UI.Color.NegativeValue + "]-35[/color].\n• For every point of deviation from [color=" + this.Const.UI.Color.NegativeValue + "]-35[/color], the bonuses increase or decrease by [color=" + this.Const.UI.Color.PositiveValue + "]1%[/color].\n• With armors of higher Fatigue Penalty, the Initiative bonus is decreased but Fatigue Cost Reduction is increased, and with armors of lower Fatigue Penalty, the Initiative bonus is increased but the Fatigue Cost Reduction is decreased.\n• The bonuses cannot be negative and cannot increase beyond [color=" + this.Const.UI.Color.PositiveValue + "]50%[/color] of Base Melee Defense.\n• Brawny does not affect this perk.\n\n[color=#0b0084]From the Sword perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.PTRPatternRecognition <- "Your experience in battle has led to you being able to quickly adapt to an opponent\'s fighting style!\n\n[color=" + this.Const.UI.Color.Passive + "][u]Passive:[/u][/color]\n• Every attack against a target and every attack against you from that target increases your Melee Skill and Melee Defense against that target by a stacking [color=" + this.Const.UI.Color.PositiveValue + "]+3[/color] for the remainder of the combat.\n\n[color=#0b0084]From the Soldier perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.DoubleStrike = "[color=" + this.Const.UI.Color.NegativeValue + "]Requires: Melee Attack[/color]\nHere, take another one!\n\n[color=" + this.Const.UI.Color.Passive + "][u]Passive:[/u][/color]\n• " + gt.Const.Strings.PerkDescription.DoubleStrike;
