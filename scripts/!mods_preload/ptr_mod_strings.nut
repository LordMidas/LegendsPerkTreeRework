...
gt.Const.PTR.modStrings <- function()
{
	...
	gt.Const.Strings.PerkDescription.PTRIntimidate <- "[color=" + this.Const.UI.Color.NegativeValue + "]Required Weapon Type: Polearm[/color]\n\n\'Trust me, ye don\'t want to be on the other end of a spile on a pole!\' Attacks from Polearms reduce the Resolve of the target by [color=" + this.Const.UI.Color.NegativeValue + "]10%[/color] of your Melee Skill. Multiple attacks from different sources stack but from the same source do not.\n[color=#0b0084]From the Polearm perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.PTRVersatileWeapon <- "[color=" + this.Const.UI.Color.NegativeValue + "]Required Weapon Type: Sword[/color]\n\nTip... edge... pommel... all parts with which to kill a man! When wielding a sword, gain [color=" + this.Const.UI.Color.PositiveValue + "]5%[/color] increased damage, [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] armor penetration and [color=" + this.Const.UI.Color.PositiveValue + "]5%[/color] increased armor effectiveness.\n[color=#0b0084]From the Sword perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.PTRTempo <- "By keeping ahead of your opponent, you set the terms of engagement! Every attack against a target who acts after you in the current round increases your Initiative by [color=" + this.Const.UI.Color.PositiveValue + "]+15[/color]. The bonus lasts until the start of your next turn.\n[color=#0b0084]From the Sword perk group[/color]";
