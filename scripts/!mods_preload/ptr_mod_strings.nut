...
gt.Const.PTR.modStrings <- function()
{
	...
	gt.Const.Strings.PerkDescription.PTRDeepCuts <- "[color=" + this.Const.UI.Color.NegativeValue + "][u]Requires:[/u] Cutting Damage[/color]\nYou know the best whetstone techniques to get your cutting edge wickedly sharp!\n\n[color=" + this.Const.UI.Color.Passive + "][u]Passive:[/u][/color]\n• During a turn, every second successful attack against the same target has a [color=" + this.Const.UI.Color.NegativeValue + "]33%[/color] lower threshold to inflict an injury and will inflict an additional stack of Bleeding for [color=" + this.Const.UI.Color.PositiveValue + "]5[/color] damage.\n• If any of the two attacks inflicted an injury, this damage is increased to [color=" + this.Const.UI.Color.PositiveValue + "]10[/color].\n\n[color=#0b0084]From the Cleaver perk group[/color]";
