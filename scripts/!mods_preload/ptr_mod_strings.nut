...
gt.Const.PTR.modStrings <- function()
{
	...
	gt.Const.Strings.PerkDescription.PTRUtilitarian <- "[color=" + this.Const.UI.Color.NegativeValue + "]Required Weapon Type: Two-Handed, Long[/color]\n\nWhen using a two-handed weapon with a range of 2 tiles, and wearing head and body armor with a total penalty to Maximum Fatigue up to [color=" + this.Const.UI.Color.NegativeValue + "]-15[/color], gain [color=" + this.Const.UI.Color.PositiveValue + "]+10[/color] Melee Skill and all skills build up [color=" + this.Const.UI.Color.NegativeValue + "]15%[/color] less Fatigue. For every 2 points of armor Fatigue above [color=" + this.Const.UI.Color.NegativeValue + "]-15[/color], you gain [color=" + this.Const.UI.Color.PositiveValue + "]+1%[/color] Melee Damage but the other bonuses drop by [color=" + this.Const.UI.Color.NegativeValue + "]-1[/color] and can be negative at high enough armor fatigue.\n[color=#0b0084]From the Polearm perk group[/color]";
