...
gt.Const.PTR.modStrings <- function()
{
	...
	gt.Const.Strings.PerkDescription.PTRFlamingArrows <- "Requires Bow. A successful Aimed Shot will now light the target tile on fire and trigger a morale check with a penalty to Resolve equal to [color=" + this.Const.UI.Color.PositiveValue + "]20%[/color] of your Ranged Skill.\n[color=#0b0084]From the Bow perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.PTRRattle <- "Requires blunt-type attack. When attacking an opponent wearing armor, if an attack does at least [color=" + this.Const.UI.Color.NegativeValue + "]10[/color] damage to Hitpoints, apply the Rattled effect which reduces the target\'s damage output by [color=" + this.Const.UI.Color.NegativeValue + "]10%[/color] for [color=" + this.Const.UI.Color.PositiveValue + "]1[/color] turn.\n[color=#0b0084]From the Hammer perk group[/color]";
	gt.Const.Strings.PerkName.PTRDeepImpact <- "Deep Impact";
	gt.Const.Strings.PerkDescription.PTRDeepImpact <- "Requires blunt-type attack. The threshold to inflict injury from blunt damage attacks is reduced by [color=" + this.Const.UI.Color.PositiveValue + "]25%[/color] of the currently equipped weapon's armor effectiveness.\n[color=#0b0084]From the Hammer perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.PTRDismantle <- "Requires hammer. Every successful hit with a hammer causes the target to receive a stacking [color=" + this.Const.UI.Color.NegativeValue + "]+15%[/color] ([color=" + this.Const.UI.Color.NegativeValue + "]+30%[/color] for Two-Handed hammers) increased damage through armor for the remainder of the combat.\n[color=#0b0084]From the Hammer perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.PTRKingOfAllWeapons <- "When using a spear, the first Thrust during your turn costs no action Points and builds no Fatigue, but does [color=" + this.Const.UI.Color.NegativeValue + "]50%[/color] reduced damage.\n[color=#0b0084]From the Spear perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.PTREasyTarget <- "Skills build up [color=" + this.Const.UI.Color.NegativeValue + "]15%[/color] less Fatigue when using Staves. All attacks with Staves have a [color=" + this.Const.UI.Color.PositiveValue + "]33%[/color] chance ([color=" + this.Const.UI.Color.PositiveValue + "]66%[/color] with Staff Daze) to apply Staggered on a hit. This chance is 100% if the target already has 2 negative status effects (stunned, dazed etc.).\n[color=#0b0084]From the Staff perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.PTRWhackASmack <- "Requires Staff. While wielding a staff, perform a free attack against anyone who misses an attack against you. This free attack has a [color=" + this.Const.UI.Color.NegativeValue + "]-20%[/color] chance to hit ([color=" + this.Const.UI.Color.NegativeValue + "]-40%[/color] if using a Swordstaff). Applies Baffled on the target if successful.\n[color=#0b0084]From the Staff perk group[/color]";
