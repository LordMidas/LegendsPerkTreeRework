...
gt.Const.PTR.modStrings <- function()
{
	...
	gt.Const.Strings.PerkDescription.PTRSanguinary <- "Why go for the body when the head is such a juicy target? The chance to inflict fatalities is increased by [color=" + this.Const.UI.Color.PositiveValue + "]50%[/color] and Fatalities refund [color=" + this.Const.UI.Color.NegativeValue + "]25%[/color] of the Base Fatigue Cost of the skill used.\n\nDuring your turn, every successful attack that applies Bleeding, or is against an already bleeding target, improves your Morale by one level, and fatalities instantly set the Morale to Confident.\n[color=#0b0084]From the Cleaver perk group[/color]";
	gt.Const.Strings.PerkName.PTRBloodlust <- "Bloodlust";
	gt.Const.Strings.PerkDescription.PTRBloodlust <- "When surrounded by carnage, you feel revitalized and right at home! During your turn, every successful attack reduces current Fatigue by [color=" + this.Const.UI.Color.NegativeValue + "]5%[/color] per stack of Bleeding on the target and increases Fatigue Recovery by [color=" + this.Const.UI.Color.PositiveValue + "]+1[/color] for one turn per stack of Bleeding on the target. Bleeding inflicted by the attack also counts towards the bonus.\n[color=#0b0084]From the Cleaver perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.PTRSurvivalInstinct <- "Your will to live is strong! Melee and Ranged Defense are increased by a stacking [color=" + this.Const.UI.Color.PositiveValue + "]+5[/color] whenever you get hit. You lose two-thirds of the stacks every turn.\n[color=#0b0084]From the Resilient perk group[/color]";
