...
gt.Const.PTR.modStrings <- function()
{
	...
	gt.Const.Strings.PerkDescription.PTRFlamingArrows <- "[color=" + this.Const.UI.Color.NegativeValue + "][u]Requires:[/u] Bow[/color]\nBurn them all!\n\n[color=" + this.Const.UI.Color.Passive + "][u]Passive:[/u][/color]\n• A successful Aimed Shot will now light the target tile on fire for 2 rounds and trigger an additional morale check for the target.\n\n[color=#0b0084]From the Bow perk group[/color]";
	...
	gt.Const.Strings.PerkDescription.PTREntrenched <- "You\'ve learned to fight in formation, trusting in the comrades to your front and sides to keep you safe while you go to work!\n\n[color=" + this.Const.UI.Color.Passive + "][u]Passive:[/u][/color]\n• When using a ranged weapon and standing adjacent to an ally wielding a melee weapon who is not engaged in melee, gain [color=" + this.Const.UI.Color.PositiveValue + "]+7[/color] Ranged Skill, Ranged Defense, and Resolve. The bonus increases by [color=" + this.Const.UI.Color.PositiveValue + "]+2[/color] every turn up to a maximum of [color=" + this.Const.UI.Color.PositiveValue + "]+15[/color] as long as you continue to start your turn adjacent to any ally wielding a melee weapon who is not engaged in melee.\n• While entrenched, swapping between two ranged weapons becomes a free action once per turn.\n\n[color=#0b0084]From the Crossbow perk group[/color]";
	...
	gt.Const.Strings.PerkName.PTRVigorousAssault <- "Vigorous Assault";
	gt.Const.Strings.PerkDescription.PTRVigorousAssault <- "[color=" + this.Const.UI.Color.NegativeValue + "][u]Requires:[/u] Melee or Throwing Weapon, or Unarmed[/color]\nYou\'ve learned to use the very momentum of your movement as a weapon unto itself!\n\n[color=" + this.Const.UI.Color.Passive + "][u]Passive:[/u][/color]\n• For every 2 tiles moved, the Action Point cost of your next attack is reduced by [color=" + this.Const.UI.Color.NegativeValue + "]1[/color] to a minimum of [color=" + this.Const.UI.Color.NegativeValue + "]1[/color], and the Fatigue Cost is reduced by [color=" + this.Const.UI.Color.NegativeValue + "]10%[/color].\n\n[color=#0b0084]From the Fast perk group[/color]";
