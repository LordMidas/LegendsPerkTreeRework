...
gt.Const.PTR.modStrings <- function()
{
	...
	gt.Const.Strings.PerkDescription.PTRTakeAim <- "[color=" + this.Const.UI.Color.NegativeValue + "]Required Weapon Type: Crossbow[/color] Unlocks the \'Take Aim\' skill which makes your next ranged attack during this turn ignore the hitchance penalty from obstacles. This shot cannot go astray.\n[color=#0b0084]From the Crossbow perk group[/color]";
